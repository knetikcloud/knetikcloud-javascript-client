...
*KnetikCloud.AuthProvidersApi* | [**deleteProvider**](docs/AuthProvidersApi.md#deleteProvider) | **DELETE** /auth/providers/{provider_id} | Delete an existing OAuth 2 provider
...
*KnetikCloud.InvoicesApi* | [**setAdditionalProperties**](docs/InvoicesApi.md#setAdditionalProperties) | **PUT** /invoices/{id}/properties | Set the additional properties of an invoice
...
*KnetikCloud.LogincontrollerApi* | [**login**](docs/LogincontrollerApi.md#login) | **GET** /login | login
...
*KnetikCloud.MediaVideosApi* | [**updateVideoTemplate**](docs/MediaVideosApi.md#updateVideoTemplate) | **PATCH** /media/videos/templates/{id} | Update a video template
...
*KnetikCloud.StoreApi* | [**quickNew**](docs/StoreApi.md#quickNew) | **POST** /store/quick-new | One-step invoice creation
*KnetikCloud.StoreApi* | [**quickPaid**](docs/StoreApi.md#quickPaid) | **POST** /store/quick-paid | One-step purchase when already paid
*KnetikCloud.StoreApi* | [**quickProcessing**](docs/StoreApi.md#quickProcessing) | **POST** /store/quick-processing | One-step invoice creation when already processing
...
*KnetikCloud.StoreVendorsApi* | [**updateVendorTemplate**](docs/StoreVendorsApi.md#updateVendorTemplate) | **PATCH** /vendors/templates/{id} | Update a vendor template
...
*KnetikCloud.TemplatesApi* | [**createTemplate**](docs/TemplatesApi.md#createTemplate) | **POST** /templates/{type_hint} | Create a template
*KnetikCloud.TemplatesApi* | [**deleteTemplate**](docs/TemplatesApi.md#deleteTemplate) | **DELETE** /templates/{type_hint}/{id} | Delete a template
*KnetikCloud.TemplatesApi* | [**getTemplate**](docs/TemplatesApi.md#getTemplate) | **GET** /templates/{type_hint}/{id} | Get a template
*KnetikCloud.TemplatesApi* | [**getTemplates**](docs/TemplatesApi.md#getTemplates) | **GET** /templates/{type_hint} | List and search templates
*KnetikCloud.TemplatesApi* | [**patchTemplate**](docs/TemplatesApi.md#patchTemplate) | **PATCH** /templates/{type_hint}/{id} | Patch a template
*KnetikCloud.TemplatesApi* | [**validate**](docs/TemplatesApi.md#validate) | **POST** /templates/{type_hint}/validate | Validate a templated resource
...
*KnetikCloud.UsersApi* | [**updateUserTemplate**](docs/UsersApi.md#updateUserTemplate) | **PATCH** /users/templates/{id} | Update a user template
...
*KnetikCloud.UsersGroupsApi* | [**createGroupMemberTemplate**](docs/UsersGroupsApi.md#createGroupMemberTemplate) | **POST** /users/groups/members/templates | Create a group member template
...
*KnetikCloud.UsersGroupsApi* | [**deleteGroupMemberTemplate**](docs/UsersGroupsApi.md#deleteGroupMemberTemplate) | **DELETE** /users/groups/members/templates/{id} | Delete a group member template
...
*KnetikCloud.UsersGroupsApi* | [**updateGroupMemberOrder**](docs/UsersGroupsApi.md#updateGroupMemberOrder) | **PUT** /users/groups/{unique_name}/members/{user_id}/order | Change a user&#39;s order
*KnetikCloud.UsersGroupsApi* | [**updateGroupMemberProperties**](docs/UsersGroupsApi.md#updateGroupMemberProperties) | **PUT** /users/groups/{unique_name}/members/{user_id}/properties | Change a user&#39;s membership properties
...
*KnetikCloud.UsersGroupsApi* | [**updateGroupMemberTemplate**](docs/UsersGroupsApi.md#updateGroupMemberTemplate) | **PATCH** /users/groups/members/templates/{id} | Update a group member template
*KnetikCloud.UsersGroupsApi* | [**updateGroupTemplate**](docs/UsersGroupsApi.md#updateGroupTemplate) | **PATCH** /users/groups/templates/{id} | Update a group template
...
*KnetikCloud.UsersInventoryApi* | [**getInventoryList**](docs/UsersInventoryApi.md#getInventoryList) | **GET** /inventories | List the user inventory entries for all users
...
*KnetikCloud.UsersInventoryApi* | [**updateEntitlementTemplate**](docs/UsersInventoryApi.md#updateEntitlementTemplate) | **PATCH** /entitlements/templates/{id} | Update an entitlement template
...
*KnetikCloud.UsersRelationshipsApi* | [**getRelationship**](docs/UsersRelationshipsApi.md#getRelationship) | **GET** /users/relationships/{id} | Get a user relationship
...
*KnetikCloud.VerificationApi* | [**createRequestTemplate**](docs/VerificationApi.md#createRequestTemplate) | **POST** /verification/templates | Create a request template
*KnetikCloud.VerificationApi* | [**createVerificationRequest**](docs/VerificationApi.md#createVerificationRequest) | **POST** /verification/requests | Create a new request
*KnetikCloud.VerificationApi* | [**deleteRequestTemplate**](docs/VerificationApi.md#deleteRequestTemplate) | **DELETE** /verification/templates/{id} | Delete a request template
*KnetikCloud.VerificationApi* | [**deleteVerificationRequest**](docs/VerificationApi.md#deleteVerificationRequest) | **DELETE** /verification/requests/{code} | Delete an existing request
*KnetikCloud.VerificationApi* | [**getRequestTemplate**](docs/VerificationApi.md#getRequestTemplate) | **GET** /verification/templates/{id} | Get a single request template
*KnetikCloud.VerificationApi* | [**getRequestTemplates**](docs/VerificationApi.md#getRequestTemplates) | **GET** /verification/templates | List and search request templates
*KnetikCloud.VerificationApi* | [**getVerificationRequest**](docs/VerificationApi.md#getVerificationRequest) | **GET** /verification/requests/{code} | Get a single verification request
*KnetikCloud.VerificationApi* | [**getVerificationRequests**](docs/VerificationApi.md#getVerificationRequests) | **GET** /verification/requests | List requests
*KnetikCloud.VerificationApi* | [**updateRequestTemplate**](docs/VerificationApi.md#updateRequestTemplate) | **PATCH** /verification/templates/{id} | Update a request template
*KnetikCloud.VerificationApi* | [**updateVerificationRequest**](docs/VerificationApi.md#updateVerificationRequest) | **PUT** /verification/requests/{code} | Update an existing request
*KnetikCloud.VerificationApi* | [**verifyRequest**](docs/VerificationApi.md#verifyRequest) | **POST** /verification/requests/{code}/responses | Verify a request
...
## Documentation for Models
 ...
 - [KnetikCloud.AccessResultsResource](docs/AccessResultsResource.md)
 ...
 - [KnetikCloud.ClientCustomizationResource](docs/ClientCustomizationResource.md)
 ...
 - [KnetikCloud.LongWrapper](docs/LongWrapper.md)
 ...
 - [KnetikCloud.OAuth2ProviderResource](docs/OAuth2ProviderResource.md)
 ...
 - [KnetikCloud.PageResourceAccessResultsResource](docs/PageResourceAccessResultsResource.md)
 ...
 - [KnetikCloud.PageResourceActionResource](docs/PageResourceActionResource.md)
 ...
 - [KnetikCloud.PageResourceAnswerResource](docs/PageResourceAnswerResource.md)
 ...
 - [KnetikCloud.PageResourceBehaviorDefinitionResource](docs/PageResourceBehaviorDefinitionResource.md)
 ...
 - [KnetikCloud.PageResourceChatBlacklistResource](docs/PageResourceChatBlacklistResource.md)
 ...
 - [KnetikCloud.PageResourceCountryResource](docs/PageResourceCountryResource.md)
 ...
 - [KnetikCloud.PageResourceDeltaResource](docs/PageResourceDeltaResource.md)
 - [KnetikCloud.PageResourceDeviceResource](docs/PageResourceDeviceResource.md)
 - [KnetikCloud.PageResourceDispositionCount](docs/PageResourceDispositionCount.md)
 ...
 - [KnetikCloud.PageResourceExpressionResource](docs/PageResourceExpressionResource.md)
 ...
 - [KnetikCloud.PageResourceGrantTypeResource](docs/PageResourceGrantTypeResource.md)
 ...
 - [KnetikCloud.PageResourceInventorySubscriptionResource](docs/PageResourceInventorySubscriptionResource.md)
 ...
 - [KnetikCloud.PageResourceOAuth2ProviderResource](docs/PageResourceOAuth2ProviderResource.md)
 ...
 - [KnetikCloud.PageResourcePaymentMethodResource](docs/PageResourcePaymentMethodResource.md)
 ...
 - [KnetikCloud.PageResourcePropertyFieldListResource](docs/PageResourcePropertyFieldListResource.md)
 ...
 - [KnetikCloud.PageResourceSearchDocument](docs/PageResourceSearchDocument.md)
 ...
 - [KnetikCloud.PageResourceStateResource](docs/PageResourceStateResource.md)
 ...
 - [KnetikCloud.PageResourceVariableTypeResource](docs/PageResourceVariableTypeResource.md)
 - [KnetikCloud.PageResourceVendorResource](docs/PageResourceVendorResource.md)
 - [KnetikCloud.PageResourceVerificationRequest](docs/PageResourceVerificationRequest.md)
 ...
 - [KnetikCloud.PasswordChangeRequest](docs/PasswordChangeRequest.md)
 - [KnetikCloud.PasswordResetRequest](docs/PasswordResetRequest.md)
 - [KnetikCloud.PatchActionResource](docs/PatchActionResource.md)
 - [KnetikCloud.PatchResource](docs/PatchResource.md)
 ...
 - [KnetikCloud.QuickPaidRequest](docs/QuickPaidRequest.md)
 ...
 - [KnetikCloud.VerificationRequest](docs/VerificationRequest.md)
