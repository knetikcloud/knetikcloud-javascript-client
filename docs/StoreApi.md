...
<a name="quickPaid"></a>
# **quickPaid**
> InvoiceResource quickPaid(opts)
...
var opts = { 
  'quickPaidRequest': new KnetikCloud.QuickPaidRequest() // QuickPaidRequest | Quick buy details
};
apiInstance.quickPaid(opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
# **quickProcessing**
> InvoiceResource quickProcessing(opts)
...
var opts = { 
  'quickProcessingRequest': new KnetikCloud.QuickPaidRequest() // QuickPaidRequest | Quick processing details
};
apiInstance.quickProcessing(opts).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
