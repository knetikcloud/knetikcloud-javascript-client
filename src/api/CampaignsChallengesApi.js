...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.CampaignsChallengesApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.ChallengeActivityResource, root.KnetikCloud.ChallengeEventResource, root.KnetikCloud.ChallengeResource, root.KnetikCloud.PageResourceBareChallengeActivityResource, root.KnetikCloud.PageResourceChallengeEventResource, root.KnetikCloud.PageResourceChallengeResource, root.KnetikCloud.PageResourceTemplateResource, root.KnetikCloud.PatchResource, root.KnetikCloud.Result, root.KnetikCloud.TemplateResource);
  }
}(this, function(ApiClient, ChallengeActivityResource, ChallengeEventResource, ChallengeResource, PageResourceBareChallengeActivityResource, PageResourceChallengeEventResource, PageResourceChallengeResource, PageResourceTemplateResource, PatchResource, Result, TemplateResource) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    this.updateChallengeActivityTemplateWithHttpInfo = function(id, opts) {
      ...
      return this.apiClient.callApi(
        '/challenge-activities/templates/{id}', 'PATCH',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
