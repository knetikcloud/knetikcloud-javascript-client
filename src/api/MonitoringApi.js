...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.getIncidentEventsWithHttpInfo = function(id, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getIncidentEvents");
      }
     ...
     */
    this.getIncidentEvents = function(id, opts) {
      return this.getIncidentEventsWithHttpInfo(id, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.postDatapointWithHttpInfo = function(id, opts) {
      opts = opts || {};
      var postBody = opts['metricDatapoint'];

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling postDatapoint");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.postDatapoint = function(id, opts) {
      return this.postDatapointWithHttpInfo(id, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
