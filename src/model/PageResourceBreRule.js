...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BreRule', 'model/Order'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BreRule'), require('./Order'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikCloud) {
      root.KnetikCloud = {};
    }
    root.KnetikCloud.PageResourceBreRule = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.BreRule, root.KnetikCloud.Order);
  }
}(this, function(ApiClient, BreRule, Order) {
  'use strict';
