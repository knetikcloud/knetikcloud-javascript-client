...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Config', 'model/Order'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Config'), require('./Order'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikCloud) {
      root.KnetikCloud = {};
    }
    root.KnetikCloud.PageResourceConfig = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.Config, root.KnetikCloud.Order);
  }
}(this, function(ApiClient, Config, Order) {
  'use strict';
