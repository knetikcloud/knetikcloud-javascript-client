...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CountryTaxResource', 'model/Order'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CountryTaxResource'), require('./Order'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikCloud) {
      root.KnetikCloud = {};
    }
    root.KnetikCloud.PageResourceCountryTaxResource = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.CountryTaxResource, root.KnetikCloud.Order);
  }
}(this, function(ApiClient, CountryTaxResource, Order) {
  'use strict';
