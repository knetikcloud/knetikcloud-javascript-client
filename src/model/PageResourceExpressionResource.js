...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.PageResourceExpressionResource = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.ExpressionResource);
  }
  ...
  /**
   * The PageResourceExpressionResource model module.
   * @module model/PageResourceExpressionResource
   * @version 3.0.270
   */

  /**
   * Constructs a new <code>PageResourceExpressionResource</code>.
   * @alias module:model/PageResourceExpressionResource
   * @class
   */
  ...
  /**
   * Constructs a <code>PageResourceExpressionResource</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageResourceExpressionResource} obj Optional instance to populate.
   * @return {module:model/PageResourceExpressionResource} The populated <code>PageResourceExpressionResource</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [ExpressionResource]);
      }
  ...
  var discriminatorValue = 'PageResource«ExpressionResource»';


  /**
   * @member {Array.<module:model/ExpressionResource>} content
   */
