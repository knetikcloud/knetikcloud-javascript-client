...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ForwardLog', 'model/Order'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ForwardLog'), require('./Order'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikCloud) {
      root.KnetikCloud = {};
    }
    root.KnetikCloud.PageResourceForwardLog = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.ForwardLog, root.KnetikCloud.Order);
  }
}(this, function(ApiClient, ForwardLog, Order) {
  'use strict';
