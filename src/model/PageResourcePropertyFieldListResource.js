...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.PageResourcePropertyFieldListResource = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.PropertyFieldListResource);
  }
  ...
  /**
   * Constructs a new <code>PageResourcePropertyFieldListResource</code>.
   * @alias module:model/PageResourcePropertyFieldListResource
   * @class
   */
  ...
  /**
   * Constructs a <code>PageResourcePropertyFieldListResource</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageResourcePropertyFieldListResource} obj Optional instance to populate.
   * @return {module:model/PageResourcePropertyFieldListResource} The populated <code>PageResourcePropertyFieldListResource</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [PropertyFieldListResource]);
      }
  ...
  var discriminatorValue = 'PageResource«PropertyFieldListResource»';


  /**
   * @member {Array.<module:model/PropertyFieldListResource>} content
   */
