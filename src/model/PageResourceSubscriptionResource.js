...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Order', 'model/SubscriptionResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Order'), require('./SubscriptionResource'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikCloud) {
      root.KnetikCloud = {};
    }
    root.KnetikCloud.PageResourceSubscriptionResource = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.Order, root.KnetikCloud.SubscriptionResource);
  }
}(this, function(ApiClient, Order, SubscriptionResource) {
  'use strict';
