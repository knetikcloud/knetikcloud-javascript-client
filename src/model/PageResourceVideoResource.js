...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Order', 'model/VideoResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Order'), require('./VideoResource'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikCloud) {
      root.KnetikCloud = {};
    }
    root.KnetikCloud.PageResourceVideoResource = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.Order, root.KnetikCloud.VideoResource);
  }
}(this, function(ApiClient, Order, VideoResource) {
  'use strict';
