...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Order', 'model/WalletTotalResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Order'), require('./WalletTotalResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikCloud) {
      root.KnetikCloud = {};
    }
    root.KnetikCloud.PageResourceWalletTotalResponse = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.Order, root.KnetikCloud.WalletTotalResponse);
  }
}(this, function(ApiClient, Order, WalletTotalResponse) {
  'use strict';
