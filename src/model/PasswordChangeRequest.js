...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.PasswordChangeRequest = factory(root.KnetikCloud.ApiClient);
  }
   ...
   * @class
   * @param value {String} The new password in plain text
   */
  ...
  var discriminatorValue = 'PasswordChangeRequest';
