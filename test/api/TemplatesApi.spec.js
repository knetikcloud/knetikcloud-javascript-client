...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.TemplatesApi();
  });
  ...
  describe('TemplatesApi', function() {
    ...
    describe('patchTemplate', function() {
      it('should call patchTemplate successfully', function(done) {
        //uncomment below and update the code to test patchTemplate
        //instance.patchTemplate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
