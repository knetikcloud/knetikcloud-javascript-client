...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceAccessResultsResource();
  });
  ...
  describe('PageResourceAccessResultsResource', function() {
    it('should create an instance of PageResourceAccessResultsResource', function() {
      // uncomment below and update the code to test PageResourceAccessResultsResource
      //var instane = new KnetikCloud.PageResourceAccessResultsResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceAccessResultsResource);
    });
