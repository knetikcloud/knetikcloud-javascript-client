...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceActionResource();
  });
  ...
  describe('PageResourceActionResource', function() {
    it('should create an instance of PageResourceActionResource', function() {
      // uncomment below and update the code to test PageResourceActionResource
      //var instane = new KnetikCloud.PageResourceActionResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceActionResource);
    });
