...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceAnswerResource();
  });
  ...
  describe('PageResourceAnswerResource', function() {
    it('should create an instance of PageResourceAnswerResource', function() {
      // uncomment below and update the code to test PageResourceAnswerResource
      //var instane = new KnetikCloud.PageResourceAnswerResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceAnswerResource);
    });
