...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceBehaviorDefinitionResource();
  });
  ...
  describe('PageResourceBehaviorDefinitionResource', function() {
    it('should create an instance of PageResourceBehaviorDefinitionResource', function() {
      // uncomment below and update the code to test PageResourceBehaviorDefinitionResource
      //var instane = new KnetikCloud.PageResourceBehaviorDefinitionResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceBehaviorDefinitionResource);
    });
