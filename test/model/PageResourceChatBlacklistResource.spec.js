...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceChatBlacklistResource();
  });
  ...
  describe('PageResourceChatBlacklistResource', function() {
    it('should create an instance of PageResourceChatBlacklistResource', function() {
      // uncomment below and update the code to test PageResourceChatBlacklistResource
      //var instane = new KnetikCloud.PageResourceChatBlacklistResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceChatBlacklistResource);
    });
