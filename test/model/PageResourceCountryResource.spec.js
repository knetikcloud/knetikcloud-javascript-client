...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceCountryResource();
  });
  ...
  describe('PageResourceCountryResource', function() {
    it('should create an instance of PageResourceCountryResource', function() {
      // uncomment below and update the code to test PageResourceCountryResource
      //var instane = new KnetikCloud.PageResourceCountryResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceCountryResource);
    });
