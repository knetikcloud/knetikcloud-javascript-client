...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceDeltaResource();
  });
  ...
  describe('PageResourceDeltaResource', function() {
    it('should create an instance of PageResourceDeltaResource', function() {
      // uncomment below and update the code to test PageResourceDeltaResource
      //var instane = new KnetikCloud.PageResourceDeltaResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceDeltaResource);
    });
