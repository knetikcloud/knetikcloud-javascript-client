...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceDispositionCount();
  });
  ...
  describe('PageResourceDispositionCount', function() {
    it('should create an instance of PageResourceDispositionCount', function() {
      // uncomment below and update the code to test PageResourceDispositionCount
      //var instane = new KnetikCloud.PageResourceDispositionCount();
      //expect(instance).to.be.a(KnetikCloud.PageResourceDispositionCount);
    });
