...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceExpressionResource();
  });
  ...
  describe('PageResourceExpressionResource', function() {
    it('should create an instance of PageResourceExpressionResource', function() {
      // uncomment below and update the code to test PageResourceExpressionResource
      //var instane = new KnetikCloud.PageResourceExpressionResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceExpressionResource);
    });
