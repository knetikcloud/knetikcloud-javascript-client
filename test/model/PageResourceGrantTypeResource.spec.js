...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceGrantTypeResource();
  });
  ...
  describe('PageResourceGrantTypeResource', function() {
    it('should create an instance of PageResourceGrantTypeResource', function() {
      // uncomment below and update the code to test PageResourceGrantTypeResource
      //var instane = new KnetikCloud.PageResourceGrantTypeResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceGrantTypeResource);
    });
