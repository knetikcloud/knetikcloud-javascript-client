...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceInventorySubscriptionResource();
  });
  ...
  describe('PageResourceInventorySubscriptionResource', function() {
    it('should create an instance of PageResourceInventorySubscriptionResource', function() {
      // uncomment below and update the code to test PageResourceInventorySubscriptionResource
      //var instane = new KnetikCloud.PageResourceInventorySubscriptionResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceInventorySubscriptionResource);
    });
