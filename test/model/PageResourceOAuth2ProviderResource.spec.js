...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceOAuth2ProviderResource();
  });
  ...
  describe('PageResourceOAuth2ProviderResource', function() {
    it('should create an instance of PageResourceOAuth2ProviderResource', function() {
      // uncomment below and update the code to test PageResourceOAuth2ProviderResource
      //var instane = new KnetikCloud.PageResourceOAuth2ProviderResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceOAuth2ProviderResource);
    });
