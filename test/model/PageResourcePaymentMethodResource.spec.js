...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourcePaymentMethodResource();
  });
  ...
  describe('PageResourcePaymentMethodResource', function() {
    it('should create an instance of PageResourcePaymentMethodResource', function() {
      // uncomment below and update the code to test PageResourcePaymentMethodResource
      //var instane = new KnetikCloud.PageResourcePaymentMethodResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourcePaymentMethodResource);
    });
