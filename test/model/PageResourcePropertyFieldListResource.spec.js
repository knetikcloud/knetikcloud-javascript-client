...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourcePropertyFieldListResource();
  });
  ...
  describe('PageResourcePropertyFieldListResource', function() {
    it('should create an instance of PageResourcePropertyFieldListResource', function() {
      // uncomment below and update the code to test PageResourcePropertyFieldListResource
      //var instane = new KnetikCloud.PageResourcePropertyFieldListResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourcePropertyFieldListResource);
    });
