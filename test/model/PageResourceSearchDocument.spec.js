...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceSearchDocument();
  });
  ...
  describe('PageResourceSearchDocument', function() {
    it('should create an instance of PageResourceSearchDocument', function() {
      // uncomment below and update the code to test PageResourceSearchDocument
      //var instane = new KnetikCloud.PageResourceSearchDocument();
      //expect(instance).to.be.a(KnetikCloud.PageResourceSearchDocument);
    });
