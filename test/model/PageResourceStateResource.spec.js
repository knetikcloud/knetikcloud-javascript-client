...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceStateResource();
  });
  ...
  describe('PageResourceStateResource', function() {
    it('should create an instance of PageResourceStateResource', function() {
      // uncomment below and update the code to test PageResourceStateResource
      //var instane = new KnetikCloud.PageResourceStateResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceStateResource);
    });
