...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceVariableTypeResource();
  });
  ...
  describe('PageResourceVariableTypeResource', function() {
    it('should create an instance of PageResourceVariableTypeResource', function() {
      // uncomment below and update the code to test PageResourceVariableTypeResource
      //var instane = new KnetikCloud.PageResourceVariableTypeResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceVariableTypeResource);
    });
