...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceVerificationRequest();
  });
  ...
  describe('PageResourceVerificationRequest', function() {
    it('should create an instance of PageResourceVerificationRequest', function() {
      // uncomment below and update the code to test PageResourceVerificationRequest
      //var instane = new KnetikCloud.PageResourceVerificationRequest();
      //expect(instance).to.be.a(KnetikCloud.PageResourceVerificationRequest);
    });
